/*
	...
	Copyright (c) 1997-2021 by InterSystems.
...
/* IRIS_IF_ERRORLIMIT is the limit of the callin interface error codes.*/
#define	IRIS_MAXIFERROR	  (-(IRIS_ATTACH))
/* WARNING!!!! You need to update IRIS_MAXIFERROR and
   callin_if_errortab[] text in callin.c when you need to add a new
   error code here. */
#define IRIS_ATTACH	  -21	/* Unable to attach shared memory */
#define IRIS_LICENSE	  -20	/* License problem */
#define IRIS_MISMATCH	  -19	/* Executable & library version mismatch */
#define IRIS_NOT_RUNNING  -18	/* Instance is not running */
...
#define	IRIS_ERPROTGVDB		181	/* <PROTECT> */
...
#define IRIS_ERFIPS		208	/* <FIPS RESTRICT> */
#define	IRIS_ERVECTOR		209	/* <VECTOR> */
#define IRIS_ERNESTDEEP		210	/* <NESTED TOO DEEP> */
#define IRIS_ERPYTHONEXC	211	/* <PYTHON EXCEPTION> */
#define IRIS_ERMAX		211	/* Maximum error number */
...
extern	int  CFPROTOD(IrisSecureStartTokenA,(char const *,IRIS_ASTRP,unsigned long,int,IRIS_ASTRP,IRIS_ASTRP));
extern	int  CFPROTOD(IrisSecureStartTokenW,(char const *,IRISWSTRP,unsigned long,int,IRISWSTRP,IRISWSTRP));
...
extern	int  CFPROTOD(IrisSecureStartTokenH,(char const *,IRISHSTRP,unsigned long,int,IRISHSTRP,IRISHSTRP));
...
#define	IRISSECURESTARTTOKENA(token,exename,flags,tout,prinp,prout) IrisSecureStartTokenA(token,exename,flags,tout,prinp,prout)
#define	IRISSECURESTARTTOKENW(token,exename,flags,tout,prinp,prout) IrisSecureStartTokenW(token,exename,flags,tout,prinp,prout)
...
#define	IRISSECURESTARTTOKENH(token,exename,flags,tout,prinp,prout) IrisSecureStartTokenH(token,exename,flags,tout,prinp,prout)
...
#define	IRISSECURESTARTTOKENH(token,exename,flags,tout,prinp,prout) IrisSecureStartTokenW(token,exename,flags,tout,prinp,prout)
...
#define	IrisSecureStartToken	IrisSecureStartTokenW
...
#define	IrisSecureStartToken	IrisSecureStartTokenH
#define	IrisChangePassword	IrisChangePasswordH
#define	IRISCVTIN		IRISCVTINH
#define	IRISCVTOUT		IRISCVTOUTH
...
#define	IrisSecureStartToken	IrisSecureStartTokenA

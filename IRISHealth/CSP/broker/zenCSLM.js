...
ZLM.drag=function(element, event) {
	...
	function moveHandler(e) {
		...
		var compatibilityView = (navigator.userAgent.split("MSIE 7.0").length === 2) && (navigator.userAgent.split("Trident/7.0").length === 2);
		if (notIE9 && !compatibilityView && e.buttons==0) {
			upHandler(e);
			return;
		}

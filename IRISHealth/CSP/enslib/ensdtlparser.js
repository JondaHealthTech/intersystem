	...
	for (var n = 0; n < expr.length; n++) {
		...
		case 0:
			...
			if (ch == '\"') {
				...
				// ObjectScript pattern match (HCR106)
				state = 9;
				token = ch;
				firsttok = false;
			}
		...
		case 2:
			...
			if (!isNaN(parseInt(ch))) {
				...
				// ObjectScript pattern match (HCR)
				state = 9;
				token = ch;
				firsttok = false;
			}
...
lookupTable.BinaryOpChar['\''] = true;
lookupTable.BinaryOpChar['|'] = true;
lookupTable.BinaryOpChar['_'] = true;
lookupTable.BinaryOpChar['['] = true;
lookupTable.BinaryOpChar[']'] = true;
